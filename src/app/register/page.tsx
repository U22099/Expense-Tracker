    ...
    transition={{duration: 1}} className="flex flex-col justify-center items-center gap-3 w-screen min-h-screen bg-gray-200 dark:bg-black p-3 pb-10">
      ...
      <motion.div variants={parentVariant}>
        <form action={formAction} className="flex flex-col gap-4 mx-auto mt-3">
          <motion.input variants={childrenVariant} type="text" name="firstname" placeholder="Firstname" className="flex p-2 items-center w-[80vw] md:w-[40vw] rounded-lg bg-white text-[1.2em] md:text-[1.5em] shadow-md text-black custom-font"/>
          <motion.input variants={childrenVariant}  type="text" name="lastname" placeholder="Lastname" className="flex p-2 items-center w-[80vw] md:w-[40vw] rounded-lg bg-white text-[1.2em] md:text-[1.5em] shadow-md text-black custom-font"/>
