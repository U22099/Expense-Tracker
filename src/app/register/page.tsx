...
export default function Page() {
  ...
  const [state, formAction] = useFormState(handleRegister , undefined) as [{error?: string, success?: string} | undefined, string | ((formData: FormData) => Promise<Object>) | undefined, boolean]
