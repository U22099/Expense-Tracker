     ...
     className="flex flex-col justify-start items-center gap-3 w-screen min-h-screen bg-gray-200 dark:bg-black p-3 pb-10">
      ...
      <motion.div variants={parentVariant} initial="hidden" animate="visible">
        <form action={handleSocialLogin} className="flex flex-col gap-3 mx-auto mt-4">
          <motion.button variants={childrenVariant} initial="hidden" animate="visible" name="provider" value="google" className="p-2 px-5 items-center w-[80vw] md:w-[40vw] rounded-full bg-black text-white dark:bg-white dark:text-black text-[1.2em] md:text-[1.5em] flex justify-center gap-4"><FcGoogle className="text-3xl custom-font"/> Sign In with Google</motion.button>
