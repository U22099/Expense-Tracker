...
export default function Home() {
  return (
    <div className="flex flex-col justify-start items-center gap-3 w-screen h-screen bg-white dark:bg-black p-3">
      <Image src="/Logo.JPG" alt="logo" className="rounded-full object-cover w-28 h-28 md:w-32 md:h-32 mx-auto mb-4 mt-4"/>
      ...
      <hr className="w-[70vw] md:w-[35vw] mx-auto border-black dark:border-white"/>
    </div>
  );
}