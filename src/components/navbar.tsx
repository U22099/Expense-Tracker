...
export default function NavBar(){
    ...
    return(
        <motion.div variants={container} initial="hidden" animate="visible" className="h-fit w-full md:w-[60vw] w-[70vw] flex justify-between items-center px-3 md:px-5 py-3 md:py-5 bg-black dark:bg-white rounded-full">
