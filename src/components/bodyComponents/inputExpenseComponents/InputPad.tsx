  ...
  return(
    <main className="flex gap-2">
      ...
      <section className="grid grid-rows-[1fr_4fr] gap-2">
        ...
        <div className="flex justify-center items-center text-lg shadow-xl active:shadow-none rounded-lg px-2 bg-white dark:bg-black dark:text-white font-bold w-full text-center h-full" onClick={submit}>
          <p>submit</p>
        </div>
      </section>
    </main>
