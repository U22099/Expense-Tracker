...
export default function InputExpense(){
  ...
  const [ category, setCategory ]= useState<string>("Housing");
    ...
    return(
        ...
        className="flex flex-col justify-start items-start gap-2 py-2 px-4 rounded-xl bg-black dark:bg-white fixed bottom-18 w-fit h-fit backdrop-blur-md mx-auto self-center">
